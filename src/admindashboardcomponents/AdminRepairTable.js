...
const mechanicCount = mechanicRequests.length;
...
>
  ...
  <div style={{ height: 600 }}>
    <DataGrid
      rows={mechanicRequests.map((req, index) => ({
        id: req._id || index,
        slNo: index + 1,
        ...
        forwardedToMechanic: req.forwardedToMechanic
      }))}
      columns={[
        { field: 'slNo', headerName: 'Sl No', width: 90 },
        { field: 'vehicleNo', headerName: 'Vehicle No', width: 130 },
  ...
  <div style={{ height: 600 }}>
    <DataGrid
      rows={certificateRequests.map((cert, index) => ({
        id: cert._id || index,
        slNo: cert.slNo,
        date: cert.date,
        pen: cert.pen,
